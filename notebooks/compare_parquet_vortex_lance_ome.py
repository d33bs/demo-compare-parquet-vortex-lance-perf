...
columns + 1 OME-Arrow image column) and benchmark on-disk formats.
...
PLOT_TITLE = (__doc__ or "Parquet vs. Vortex vs. Lance performance (with OME-Arrow)").splitlines()[0]
DATA_DIR = Path("data")
